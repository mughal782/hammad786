            ...
            <div class="footer px-0">
                <div class="row justify-content-center text p-0">
                    <div class="col-lg-2 col-xl-2 col-md-6 col-sm-6 align-self-center" style="text-align: center;">
                        <img src="logo-main.png" width="130px" height="110px"><br>
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 ml-0" style="padding-left: 0px!important;">
                                   ...
                                   <ul class="flexfooter2 down" style="list-style-type: none;">
                                                ...
                                                <li class="">
                                                    <a href="#" class="round">ABOUT US</a>
                                                </li>
                                                <li >
                                                    <a href="#" class="round">INVESTSMENTS</a>
                                                </li>
                                                <li >
                                                    <a href="#" class="round">AFFLIATES</a>
                                                </li>
                                                <li >
                                                    <a href="#" class="round">RULES</a>
                                                </li>
                                                <li>
                                                    <a href="#" class="round">TESMONIAL</a>
                                                </li>
                                                <li>
